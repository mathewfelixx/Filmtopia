...
Public Class frmSalesReport
    ...
    Private Function LoadSalesByFilm(fromDate As Date, toDate As Date) As Double
        ...
        If DbConnect() Then
            ...
            SQLCmd.CommandText = "SELECT FilmTitle, COUNT(tblBooking.BookingID) AS Bookings, SUM(TotalCost) AS TicketRevenue " &
    ...
    Private Function GetFoodRevenue(fromDate As Date, toDate As Date) As Double
        ...
        If DbConnect() Then
            ...
            SQLCmd.CommandText = "SELECT SUM(FoodItemPrice * Quantity) " &
